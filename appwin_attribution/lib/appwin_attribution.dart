...
class AppwinAttribution {
  ...
  Future<String?> getPlatformVersion() {
    return _guard(
      'getPlatformVersion',
      AppwinAttributionPlatform.instance.getPlatformVersion,
      null,
    );
  }
  ...
  Future<AppwinInitResult> initialize() {
    return _guard(
      'initialize',
      AppwinAttributionPlatform.instance.initialize,
  ...
  Future<void> setAdvertisingConsent(AppwinAdvertisingConsent consent) {
    return _guardVoid(
      ...
      () => AppwinAttributionPlatform.instance.setAdvertisingConsent(consent),
    );
  }
  ...
  Future<bool> requestTrackingAuthorization() {
    return _guard(
      ...
      AppwinAttributionPlatform.instance.requestTrackingAuthorization,
      false,
    );
  }
  ...
  Future<void> setAdSignalsDebugMode(bool enabled) {
    return _guardVoid(
      ...
      () => AppwinAttributionPlatform.instance.setAdSignalsDebugMode(enabled),
    );
  }
}
