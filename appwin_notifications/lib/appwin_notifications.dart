...
class AppwinNotifications {
  ...
  Future<AppwinInitResult> initialize() {
    return _guard(
      'initialize',
      AppwinNotificationsPlatform.instance.initialize,
  ...
  Future<void> start({bool requestPushPermission = true}) {
    return _guardVoid(
      'start',
      () => AppwinNotificationsPlatform.instance.start(
  ...
  Future<void> stop() {
    return _guardVoid('stop', AppwinNotificationsPlatform.instance.stop);
  }
  ...
  Future<void> trackEvent({
    ...
    return _guardVoid(
      'trackEvent',
      () => AppwinNotificationsPlatform.instance.trackEvent(
        event: event,
        eventName: eventName,
  ...
  Future<List<AppwinInAppMessage>> fetchPendingMessages() {
    return _guard(
      ...
      AppwinNotificationsPlatform.instance.fetchPendingMessages,
      const [],
    );
  }
  ...
  Future<void> track({
    ...
    return _guardVoid(
      'track',
      () => AppwinNotificationsPlatform.instance.track(
  ...
  Future<List<AppwinInAppMessage>> syncOnAppOpen() {
    return _guard(
      'syncOnAppOpen',
      AppwinNotificationsPlatform.instance.syncOnAppOpen,
      const [],
    );
  }
  ...
  Future<void> presentPendingMessages() {
    return _guardVoid(
      ...
      AppwinNotificationsPlatform.instance.presentPendingMessages,
    );
  }
  ...
  Future<String?> getPlatformVersion() {
    return _guard(
      'getPlatformVersion',
      AppwinNotificationsPlatform.instance.getPlatformVersion,
      null,
    );
  }
}
