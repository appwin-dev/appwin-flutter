...
class AppwinCore {
  ...
  ///
  /// Returns an empty string when the session could not open (offline,
  /// broken native install) - never throws.
  Future<String> bootstrapSession({String? externalId}) {
    return _guard(
      'bootstrapSession',
      () => AppwinCorePlatform.instance.bootstrapSession(externalId: externalId),
      '',
    );
  }
  ...
  Future<void> identify({required String externalId}) {
    return _guardVoid(
      'identify',
      () => AppwinCorePlatform.instance.identify(externalId: externalId),
    );
  }
  ...
  Future<void> clearIdentity() {
    return _guardVoid('clearIdentity', AppwinCorePlatform.instance.clearIdentity);
  }
  ...
  Future<void> signOut() {
    return _guardVoid('signOut', AppwinCorePlatform.instance.signOut);
  }
