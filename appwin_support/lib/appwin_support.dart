...
class AppwinSupport {
  ...
  Future<String?> getPlatformVersion() {
    return _guard(
      'getPlatformVersion',
      AppwinSupportPlatform.instance.getPlatformVersion,
      null,
    );
  }
  ...
  Future<AppwinInitResult> initialize() {
    return _guard(
      'initialize',
      AppwinSupportPlatform.instance.initialize,
  ...
  Future<void> presentMessenger() {
    return _guardVoid(
      'presentMessenger',
      AppwinSupportPlatform.instance.presentMessenger,
    );
  }
  ...
  Future<void> loginUnidentifiedUser() {
    return _guardVoid(
      ...
      AppwinSupportPlatform.instance.loginUnidentifiedUser,
    );
  }
  ...
  Future<void> loginIdentifiedUser({required String externalId}) {
    return _guardVoid(
      'loginIdentifiedUser',
      () => AppwinSupportPlatform.instance.loginIdentifiedUser(
  ...
  Future<void> updateUser({
    ...
    return _guardVoid(
      'updateUser',
      () => AppwinSupportPlatform.instance.updateUser(
        email: email,
        name: name,
        avatarUrl: avatarUrl,
        language: language,
